...
`@paykernel/routing` chooses a gateway id. It does **not** execute payments and does **not** automatically switch gateways after timeout, indeterminate, or uncertain 5xx. Workspace version is `0.1.0-next.0` — not a released 1.0.
