...
PayKernel is composed at the application layer. `@paykernel/core` never depends on webhooks, stores, routing, or OpenTelemetry. Current versions are `0.1.0-next.0`.
