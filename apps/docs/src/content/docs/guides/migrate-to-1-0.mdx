...
This page maps breaking changes from `0.x` to the **1.0 API** already in source. Published versions today are `0.1.0-next.0` — **not** a released npm 1.0. Each section has a **Before (0.x)** / **After (1.0)** snippet.
