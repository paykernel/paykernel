...
Package name `@paykernel/gateway-myfatoorah`, export `"."` only (`./dist/index.js`). Version `1.0.1`. Published on npm — `bun add @paykernel/gateway-tap @paykernel/core` works.
...
| `MYFATOORAH_ADAPTER_VERSION` | `"1.0.1"` |
