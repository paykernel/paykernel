...
- **PERF-6:** `handleWebhook` / composed `onWebhookVerified` isolate identity and dual-write without deep-cloning `rawPayload`. Stripe parse/hash in the gateway is unchanged.
