...
| Bug class | Result |
| --------- | ------ |
| Auto-routing indeterminate | **Blocked** — `isSafeFallbackEligible("indeterminate") === false`; classify never maps indeterminate → safe; unknown → indeterminate; AbortError → indeterminate (not fallback-eligible) |
