...
| **20.4** Redaction | same model as logs | `createRedactingTelemetrySink` → `redact()`; observability `redaction.ts` re-exports core; tests secrets + keep `providerRequestId` | **PASS** |
