...
// consumers never pull `bun:sqlite`. Import from:
//   @paykernel/internal-sql-store/src/reference/bun-sqlite-store
// or relative path under internal/sql-store/src/reference/bun-sqlite-store.ts
export {
